    ...
    <div className={props.className}>
      ...
      `}>
        <div className='flex flex-row justify-center items-center w-[100%] md:w-auto pb-3'>
          <Link href="/LandigPages/ProjetoTalentoEmpresas" className='flex items-center justify-center'><Image alt='Logo Centro Universo Salvador' className='mt-5' style={{textShadow: '2px 2px 4px rgba(0, 0, 0, 0.5)'}} src="/img/centroUniversoSalvador2.png" width={310} height={50}/></Link>
          <div className=''>
