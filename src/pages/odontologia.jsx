...
<div className={`
    ...
    <div className='flex justify-center items-start w-full mb-8'>
        <Image className='mt-8' src="/img/logoUniverso1.png" width={100} height={100}/>
    </div> 
    <div className={`flex flex-col gap-4 md:w-[60%] w-[95%] justify-center items-center`}>
        <div className={`w-[100%] border pb-4 rounded-xl bg-white flex-col justify-center items-center shadow-xl`}>
